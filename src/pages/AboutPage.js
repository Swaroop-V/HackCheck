    ...
    >
      ...
      <div className="about-content">
        <section>
          <h2>Our Mission</h2>
          <p>
            In an age where data breaches are becoming alarmingly frequent, our digital identities are constantly at risk. HackCheck was born from a simple yet powerful mission: to provide everyone with a free, fast, and secure way to check if their credentials have been compromised. We believe that digital security should be accessible to all, not just a privileged few.
          </p>
        </section>
        <section>
          <h2>How We Protect You</h2>
          <p>
            Trust is the cornerstone of our service. When you check a password with HackCheck, we ensure your privacy is never compromised. We use a sophisticated technique called <strong>k-Anonymity</strong>, which allows us to check your password against a massive database of known breaches without ever seeing, storing, or transmitting your actual password. Your security check is completely anonymous.
          </p>
        </section>
        <section>
          <h2>The Team</h2>
          <p>
            HackCheck is developed and maintained by a small team of cybersecurity enthusiasts dedicated to making the internet a safer place. We are driven by our passion for technology and a firm belief in the right to privacy.
          </p>
        </section>
